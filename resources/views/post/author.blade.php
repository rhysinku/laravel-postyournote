<x-layout>
    ...
    <h1 class="font-bold text-5xl mb-4 ">Author > <span>{{ $author->username}}</span></h1>
    ...
    <div class="flex flex-wrap justify-evenly my-2 gap-2">
        ...
        <section class="max-w-md w-full p-5 rounded-xl bg-blue-200">
            ...
            <i class=" text-sm text-blue-400 mb-2"> <a href={{ route('posts.author', $author->id)}}>{{ $author->username}}</a> </i>
            <p>{{$post->message}}</p>
